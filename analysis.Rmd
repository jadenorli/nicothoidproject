...
##I chose to only include two of the fours males we dissected because the other two males had been held for over a month before dissection and I believe that this is why they didn't have nicos -- we are planning to do a few more male dissections
...
### f) Mean Intensity (Females) (ignore)
```{r}
#calculate the mean intensity for the nicos in the gills 
