...
eggs_mort_vis_both <- ggplot() +
  geom_point(data = eggs_mort_day_avg_high, 
       aes(x = day, y = avg_prop_viable_eggs), color = "red") +
  geom_point(data = eggs_mort_day_avg_low, 
       aes(x = day, y = avg_prop_viable_eggs), color = "blue") +
  theme_gray() +
  ylab("Average Proportion Viable Crab Eggs") +
  xlab("Development Day") + 
  ggtitle(label = "Average Egg Mortality Across Development Day",
...
```{r}
#create a dataframe which has the prop of the life stage per the number of crab eggs in the sample then times 1000 (scaled)
...
ggarrange(adult_timeseries, juvenile_timeseries, total_nicos_timeseries, nico_egg_timeseries,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
...
#add the plots together
ggarrange(adult_timeseries_eds, juvenile_timeseries_eds, total_nicos_timeseries_eds, nico_egg_timeseries_eds,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
...
#add the plots together
ggarrange(adult_timeseries_high, juvenile_timeseries_high, total_nicos_timeseries_high, nico_egg_timeseries_high,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
...
#add the plots together
ggarrange(adult_timeseries_high_eds, juvenile_timeseries_high_eds, total_nicos_timeseries_high_eds, nico_egg_timeseries_high_eds,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
...
#add the plots together
ggarrange(adult_timeseries_low, juvenile_timeseries_low, total_nicos_timeseries_low, nico_egg_timeseries_low,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
...
#add the plots together
ggarrange(adult_timeseries_low_eds, juvenile_timeseries_low_eds, total_nicos_timeseries_low_eds, nico_egg_timeseries_low_eds,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
...
```{r}
#add the plots together
ggarrange(adult_timeseries_all, adult_timeseries_all_broods, nico_egg_timeseries_all, nico_egg_timeseries_all_broods,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
```
...
#add the plots together
ggarrange(adult_plot_log, juvenile_plot_log, total_plot_log, nico_egg_plot_log,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
...
#add the plots together
ggarrange(adult_plot_sqrt, juvenile_plot_sqrt, total_plot_sqrt, nico_egg_plot_sqrt,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)
