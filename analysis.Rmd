...
```{r}
#plot the number of adult nicos against the total number of nonviable eggs
...
#plot the number of juvenile nicos against the total number of nonviable eggs 
...
#plot the number of total number of nicos against the total number of nonviable eggs
...
#plot the number of nico eggs against the total number of nonviable eggs
...
#we see that there is a clear relationship between the proportion of nonviable eggs and the number of nico eggs while there isn't always this clear relationship with the total number of nicos and the proportion of nonviable eggs
## this is why I want to make the model in terms of biomass because the adult nicos are transforming the crab egg biomass directly into nico egg biomass
>>>>>>> 4fe5a1b0f86ab96a5b526542ddb9bd9d31b76dc9
```
