...
adult_counts <- autoinfection %>% 
  select(experiment_id, crab_id, date, eds, number_of_adult_copepods, number_of_nemerteans, total_number_of_eggs, number_of_copepod_eggs) %>% 
...
#save the output as as png
ggsave("freqdist_juveniles_new.png", freqdist_juveniles_new, device = "png")

freqdist_juveniles_new
