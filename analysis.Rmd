...
```{r}
glm.adults.poisson_prop <- glmer(prop_viable_eggs ~ prop_total_nicos_alone + prop_nico_eggs_alone + (1|crab_id), 
                   data = timeseries, 
                   family = "poisson")

summary(glm.adults.poisson_prop)

glm.adults.poisson <- glmer(number_viable_crab_eggs ~ number_adult_nicos*number_juvenile_nicos*eds + (1|crab_id), 
                   data = timeseries, 
                   family = "poisson")
