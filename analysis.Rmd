...
#plot the frequency of adult nicos 
## need to use crab_id data to accurately understand distribution among crabs

freqdist_adults <- gghistogram(crab_id, 
                               crab_id$avg_adult_nicos, 
                               fill = adults) +
...
#ggplot(egg_mortality, aes(price, after_stat(density), colour = cut)) +
