...
### c) Life Stage Timeseries 

#### i) Life Stages All Crabs
```{r}
#create a dataframe which has the propotion of the life stage per the number of crab eggs in the sample then times 1000 (scaled)
...
#plot the number of adults over time per 1000 host eggs
adult_timeseries_all <- ggplot(data = adult_all_avg, 
       aes(x = eds, y = avg_prop_adults)) +
  geom_point(color = adults) +
  theme_gray() +
  ylab("Adults per One Thousand Host Eggs") +
...
#plot the number of adults over time per 1000 host eggs
adult_timeseries_all_broods <- ggplot(data = adult_all_broods_avg, 
       aes(x = eds, y = avg_prop_adults)) +
  geom_point(color = adults) +
  theme_gray() +
  ylab("Adults per One Thousand Host Eggs") +
...
#plot the number of adults over time per 1000 host eggs
adult_timeseries_all_new <- ggplot(data = adult_all_avg_new, 
       aes(x = eds, y = avg_prop_adults)) +
  geom_point(color = adults) +
  theme_gray() +
  ylab("Adults per One Thousand Host Eggs") +
...
#plot the number of nico eggs over time per 1000 host eggs
nico_egg_timeseries_all <- ggplot(data = nico_egg_all_avg, 
       aes(x = eds, y = avg_prop_nico_eggs)) +
  geom_point(color = nico_eggs) +
  theme_gray() +
  ylab("Nico Eggs per One Thousand Host Eggs") +
...
#plot the number of nico eggs over time per 1000 host eggs
nico_egg_timeseries_all_broods <- ggplot(data = nico_egg_all_broods_avg, 
       aes(x = eds, y = avg_prop_nico_eggs)) +
  geom_point(color = nico_eggs) +
  theme_gray() +
  ylab("Nico Eggs per One Thousand Host Eggs") +
...
#plot the number of nico eggs over time per 1000 host eggs
nico_egg_timeseries_all_new <- ggplot(data = nico_egg_all_avg_new, 
       aes(x = eds, y = avg_prop_nico_eggs)) +
  geom_point(color = nico_eggs) +
  theme_gray() +
  ylab("Nico Eggs per One Thousand Host Eggs") +
...
#plot the number of adults over time per 1000 host eggs
adult_timeseries_all_new_day <- ggplot(data = adult_all_avg_new_day, 
       aes(x = day, y = avg_prop_adults)) +
  geom_point(color = adults) +
  theme_gray() +
  ylab("Adults per One Thousand Host Eggs") +
...
#plot the number of nico eggs over time per 1000 host eggs
nico_egg_timeseries_all_new_day <- ggplot(data = nico_egg_all_avg_new_day, 
       aes(x = day, y = avg_prop_nico_eggs)) +
  geom_point(color = nico_eggs) +
  theme_gray() +
  ylab("Nico Eggs per One Thousand Host Eggs") +
...
#### ii) Proportion Nonviable Host Eggs
```{r}
#scale up the data then log transform the data
egg_mortality_log_non <- egg_mortality %>%
  mutate(scale_prop_nonviable_eggs = prop_nonviable_eggs*1000) %>%
  mutate(log_prop_nonviable_eggs = log(scale_prop_nonviable_eggs)) %>%
  mutate(log_adult_nicos = log(number_adult_nicos + 1)) %>%
  mutate(log_juvenile_nicos = log(number_juvenile_nicos + 1)) %>%
  mutate(log_total_nicos = log(total_nicos + 1)) %>%
  mutate(log_nico_eggs = log(number_nico_eggs + 1)) 
...
#plot the number of adult nicos against the total number of viable eggs
adult_plot_log_non <- ggplot(data = egg_mortality_log_non, 
       aes(y = prop_nonviable_eggs, x = log_adult_nicos)) +
  geom_point(color = adults) + 
  #geom_smooth(method = lm, level = 0.95, color = "black") +
  theme_gray() +
  xlab("Number of Adult Nicos") +
  ylab("Proportion of Nonviable Crab Eggs") + 
  ggtitle("Adult Nicos") +
  theme(plot.title = element_text(hjust = 0.5),
        axis.title.y = element_text(size = 6),
        axis.title.x = element_text(size = 8))
...
#plot the number of juvenile nicos against the total number of viable eggs 
juvenile_plot_log_non <- ggplot(data = egg_mortality_log_non, 
       aes(y = prop_nonviable_eggs, x = log_juvenile_nicos)) +
  geom_point(color = juveniles) + 
  #geom_smooth(method = lm, level = 0.95, color = "black") +
  theme_gray() +
  xlab("Number of Larval Nicos") +
...
#plot the number of total number of nicos against the total number of viable eggs
total_plot_log_non <- ggplot(data = egg_mortality_log_non, 
       aes( y = prop_nonviable_eggs, x = log_total_nicos)) +
  geom_point(color = totals) + 
  #geom_smooth(method = lm, level = 0.95, color = "black") +
  theme_gray() +
  xlab("Total Number of Nicos (Larvae/Adults)") +
...
#plot the number of nico eggs against the total number of viable eggs
nico_egg_plot_log_non <- ggplot(data = egg_mortality_log_non, 
       aes(y = prop_nonviable_eggs, x = log_nico_eggs)) +
  geom_point(color = nico_eggs) + 
  #geom_smooth(method = lm, level = 0.95, color = "black") +
  theme_gray() +
  xlab("Number of Nico Eggs") +
...
#add the plots together
log_transformed_non <- ggarrange(adult_plot_log_non, juvenile_plot_log_non, total_plot_log_non, nico_egg_plot_log_non,
                           labels = c("a)", "b)", "c)", "d)"),
                           ncol = 2, nrow = 2)

#add a title for the figure 
annotate_figure(log_transformed_non,
               top = text_grob("Log-Transformed Data", color = "black", face = "bold", size = 14))

```

## c) Squareroot Trasform the Data (no)
```{r}
