...
egg_mortality_arcsine <- egg_mortality %>%
  mutate(scale_prop_viable_eggs = prop_viable_eggs*1000) %>%
  mutate(arcsine_prop_viable_eggs = asin(sqrt(prop_viable_eggs))) %>%
  mutate(arcsine_adult_nicos = asin(sqrt(number_adult_nicos))) %>%
  mutate(arcsine_juvenile_nicos = asin(sqrt(number_juvenile_nicos))) %>%
  mutate(arcsine_total_nicos = asin(sqrt(total_nicos))) %>%
  mutate(arcsine_nico_eggs = asin(sqrt(number_nico_eggs))) 
