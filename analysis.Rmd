...
##adults
min_adults <- min(adult_summary_new$adults_sample)
min_adults

max_adults <- max(adult_summary_new$adults_sample)
max_adults

mean_adults <- mean(adult_summary_new$adults_sample)
mean_adults

sd_adults <- sd(adult_summary_new$adults_sample)
sd_adults
